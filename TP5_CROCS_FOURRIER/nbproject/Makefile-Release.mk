...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp5_crocs_fourrier

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp5_crocs_fourrier: ${OBJECTFILES}
